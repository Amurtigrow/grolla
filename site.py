...
large_buttons = {
    "나의 아바타": "종현.mp4",  # 이 경로를 실제 아바타 비디오 파일로 변경하세요.
    "나를 표현한 음악": "내 길을 가요.mp3"  # 이 경로를 실제 음악 파일로 변경하세요.
}
...
if st.session_state.active_button == "나의 아바타":
    st.video("종현.mp4", format="video/mp4", start_time=0)

if st.session_state.active_button == "나를 표현한 음악":
    st.audio("내 길을 가요.mp3", format="audio/mp3")
